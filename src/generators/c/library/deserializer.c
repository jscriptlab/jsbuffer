...
enum jsb_result_t jsb_deserializer_read_int64(struct jsb_deserializer_t* d,
                                              jsb_int64_t* out) {
...
enum jsb_result_t jsb_deserializer_read_uint64(struct jsb_deserializer_t* d,
                                               jsb_uint64_t* out) {
  JSB_CHECK_ERROR(jsb_deserializer_assert_remaining_bytes(d, 8));
...
enum jsb_result_t jsb_deserializer_read_int32(struct jsb_deserializer_t* d,
                                              jsb_int32_t* out) {
...
enum jsb_result_t jsb_deserializer_read_uint32(struct jsb_deserializer_t* d,
                                               jsb_uint32_t* out) {
  JSB_CHECK_ERROR(jsb_deserializer_assert_remaining_bytes(d, 4));
...
enum jsb_result_t jsb_deserializer_read_uint16(struct jsb_deserializer_t* d,
                                               jsb_uint16_t* out) {
...
enum jsb_result_t jsb_deserializer_read_int16(struct jsb_deserializer_t* d,
                                              jsb_int16_t* out) {
  JSB_CHECK_ERROR(jsb_deserializer_assert_remaining_bytes(d, 2));
...
enum jsb_result_t jsb_deserializer_read_uint8(struct jsb_deserializer_t* d,
                                              jsb_uint8_t* out) {
...
enum jsb_result_t jsb_deserializer_read_int8(struct jsb_deserializer_t* d,
                                             jsb_int8_t* out) {
  JSB_CHECK_ERROR(jsb_deserializer_assert_remaining_bytes(d, 1));
...
enum jsb_result_t jsb_deserializer_read_double(struct jsb_deserializer_t* d,
                                               jsb_double_t* out) {
  JSB_CHECK_ERROR(jsb_deserializer_assert_remaining_bytes(d, 8));
...
enum jsb_result_t jsb_deserializer_read_float(struct jsb_deserializer_t* d,
                                              jsb_float_t* out) {
  JSB_CHECK_ERROR(jsb_deserializer_assert_remaining_bytes(d, 4));
 ...
 * @param out_buffer_ptr Pointer to pass a reference to the deserializer buffer
 * to
...
jsb_deserializer_read_buffer(struct jsb_deserializer_t* deserializer,
  ...
  memcpy(out_buffer_ptr, &deserializer->buffer[deserializer->offset],
         size * sizeof(jsb_uint8_t));
