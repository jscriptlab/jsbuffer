...
export function isUser(value: unknown): value is user {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "tuple-test2.user")) return false;
  if(!(
  ...
  if(!(
    "firstName" in value && ((__v1) => (typeof __v1 === 'string'))(value['firstName'])
  )) return false;
  if(!(
    "lastName" in value && ((__v2) => (typeof __v2 === 'string'))(value['lastName'])
  )) return false;
  return true;
}
...
export function isPost(value: unknown): value is post {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "tuple-test2.post")) return false;
  if(!(
    "id" in value && ((__v0) => (typeof __v0 === 'number' && JSBI.equal(JSBI.BigInt(__v0),JSBI.BigInt(__v0)) && JSBI.greaterThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("2147483647"))))(value['id'])
  )) return false;
  if(!(
  ...
  if(!(
    "comments" in value && ((__v2) => ((Array.isArray(__v2) || __v2 instanceof Set) && Array.from(__v2).every(p => (isComment(p)))))(value['comments'])
  )) return false;
  return true;
}
...
export function comparePost(__a: post, __b: post): boolean {
  return (
     ...
     */
    __a['comments'].length === __b['comments'].length && Array.from(__a['comments']).every((__originalItem2,__index2) => (typeof __originalItem2 === 'undefined' ? false : (__item2 => typeof __item2 === 'undefined' ? false : (compareComment(__originalItem2,__item2)))(Array.from(__b['comments'])[__index2])))
  );
}
export function updatePost(value: post, changes: Partial<postInputParams>) {
  ...
  if(typeof changes['comments'] !== 'undefined') {
    if(!(changes['comments'].length === value['comments'].length && Array.from(changes['comments']).every((__originalItem3,__index3) => (typeof __originalItem3 === 'undefined' ? false : (__item3 => typeof __item3 === 'undefined' ? false : (compareComment(__originalItem3,__item3)))(Array.from(value['comments'])[__index3]))))) {
      value = post({
        ...value,
...
export function isComment(value: unknown): value is comment {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "tuple-test2.comment")) return false;
  if(!(
    "id" in value && ((__v0) => (typeof __v0 === 'number' && JSBI.equal(JSBI.BigInt(__v0),JSBI.BigInt(__v0)) && JSBI.greaterThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("2147483647"))))(value['id'])
  )) return false;
  if(!(
  ...
  if(!(
    "contents" in value && ((__v2) => (typeof __v2 === 'string'))(value['contents'])
  )) return false;
  return true;
}
...
export function isTupleTest(value: unknown): value is tupleTest {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "tuple-test2.tupleTest")) return false;
  if(!(
    "data" in value && ((__v0) => (Array.isArray(__v0) && (__v0.length === 5) && ((a) => (isUser(a)))(__v0[0]) && ((a) => (isPost(a)))(__v0[1]) && ((a) => (isComment(a)))(__v0[2]) && ((a) => ((Array.isArray(a) || a instanceof Set) && Array.from(a).every(p => (isComment(p)))))(__v0[3]) && ((a) => ((Array.isArray(a) || a instanceof Set) && Array.from(a).every(p => (p === null ? true : ((x) => (isComment(x)))(p)))))(__v0[4])))(value['data'])
  )) return false;
  return true;
}
...
export function compareTupleTest(__a: tupleTest, __b: tupleTest): boolean {
  return (
     ...
     */
    /* compare tuple item 0 of type Readonly<user> */ ((__a00, __b00) => compareUser(__a00,__b00))(__a['data'][0],__b['data'][0]) && /* compare tuple item 1 of type Readonly<post> */ ((__a01, __b01) => comparePost(__a01,__b01))(__a['data'][1],__b['data'][1]) && /* compare tuple item 2 of type Readonly<comment> */ ((__a02, __b02) => compareComment(__a02,__b02))(__a['data'][2],__b['data'][2]) && /* compare tuple item 3 of type ReadonlyArray<Readonly<comment>> */ ((__a03, __b03) => __a03.length === __b03.length && Array.from(__a03).every((__originalItem10,__index10) => (typeof __originalItem10 === 'undefined' ? false : (__item10 => typeof __item10 === 'undefined' ? false : (compareComment(__originalItem10,__item10)))(Array.from(__b03)[__index10]))))(__a['data'][3],__b['data'][3]) && /* compare tuple item 4 of type ReadonlyArray<Readonly<comment> | null> */ ((__a04, __b04) => __a04.length === __b04.length && Array.from(__a04).every((__originalItem16,__index16) => (typeof __originalItem16 === 'undefined' ? false : (__item16 => typeof __item16 === 'undefined' ? false : (((__dp171, __dp172) => __dp171 !== null && __dp172 !== null ? compareComment(__dp171,__dp172) : __dp171 === __dp172)(__originalItem16,__item16)))(Array.from(__b04)[__index16]))))(__a['data'][4],__b['data'][4])
  );
}
export function updateTupleTest(value: tupleTest, changes: Partial<tupleTestInputParams>) {
  if(typeof changes['data'] !== 'undefined') {
    if(!(/* compare tuple item 0 of type Readonly<user> */ ((__a10, __b10) => compareUser(__a10,__b10))(changes['data'][0],value['data'][0]) && /* compare tuple item 1 of type Readonly<post> */ ((__a11, __b11) => comparePost(__a11,__b11))(changes['data'][1],value['data'][1]) && /* compare tuple item 2 of type Readonly<comment> */ ((__a12, __b12) => compareComment(__a12,__b12))(changes['data'][2],value['data'][2]) && /* compare tuple item 3 of type ReadonlyArray<Readonly<comment>> */ ((__a13, __b13) => __a13.length === __b13.length && Array.from(__a13).every((__originalItem11,__index11) => (typeof __originalItem11 === 'undefined' ? false : (__item11 => typeof __item11 === 'undefined' ? false : (compareComment(__originalItem11,__item11)))(Array.from(__b13)[__index11]))))(changes['data'][3],value['data'][3]) && /* compare tuple item 4 of type ReadonlyArray<Readonly<comment> | null> */ ((__a14, __b14) => __a14.length === __b14.length && Array.from(__a14).every((__originalItem17,__index17) => (typeof __originalItem17 === 'undefined' ? false : (__item17 => typeof __item17 === 'undefined' ? false : (((__dp181, __dp182) => __dp181 !== null && __dp182 !== null ? compareComment(__dp181,__dp182) : __dp181 === __dp182)(__originalItem17,__item17)))(Array.from(__b14)[__index17]))))(changes['data'][4],value['data'][4]))) {
      value = tupleTest({
        ...value,
        data: changes['data'],
      });
...
export function isTupleTupleTest(value: unknown): value is tupleTupleTest {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "tuple-test2.tupleTupleTest")) return false;
  if(!(
    "a" in value && ((__v0) => (Array.isArray(__v0) && (__v0.length === 4) && ((a) => (Array.isArray(a) && (a.length === 3) && ((a) => (typeof a === 'number' && JSBI.equal(JSBI.BigInt(a),JSBI.BigInt(a)) && JSBI.greaterThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("2147483647"))))(a[0]) && ((a) => (typeof a === 'string'))(a[1]) && ((a) => ((Array.isArray(a) || a instanceof Set) && Array.from(a).every(p => (Array.isArray(p) && (p.length === 2) && ((a) => (typeof a === 'string'))(p[0]) && ((a) => (typeof a === 'number' && JSBI.equal(JSBI.BigInt(a),JSBI.BigInt(a)) && JSBI.greaterThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("2147483647"))))(p[1])))))(a[2])))(__v0[0]) && ((a) => (typeof a === 'number' && JSBI.equal(JSBI.BigInt(a),JSBI.BigInt(a)) && JSBI.greaterThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("2147483647"))))(__v0[1]) && ((a) => (typeof a === 'string'))(__v0[2]) && ((a) => (typeof a === 'number'))(__v0[3])))(value['a'])
  )) return false;
  return true;
}
...
export function isSuperTupleTupleTest(value: unknown): value is superTupleTupleTest {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "tuple-test2.superTupleTupleTest")) return false;
  if(!(
    "a" in value && ((__v0) => (Array.isArray(__v0) && (__v0.length === 2) && ((a) => (Array.isArray(a) && (a.length === 2) && ((a) => (Array.isArray(a) && (a.length === 1) && ((a) => (typeof a === 'number' && JSBI.equal(JSBI.BigInt(a),JSBI.BigInt(a)) && JSBI.greaterThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("2147483647"))))(a[0])))(a[0]) && ((a) => (typeof a === 'number' && JSBI.equal(JSBI.BigInt(a),JSBI.BigInt(a)) && JSBI.greaterThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("2147483647"))))(a[1])))(__v0[0]) && ((a) => (typeof a === 'number'))(__v0[1])))(value['a'])
  )) return false;
  return true;
}
