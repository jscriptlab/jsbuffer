...
export function isUser(value: unknown): value is user {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "user.user")) return false;
  if(!(
    "firstName" in value && ((__v0) => (typeof __v0 === 'string'))(value['firstName'])
  )) return false;
  if(!(
    "aliases" in value && ((__v1) => ((Array.isArray(__v1) || __v1 instanceof Set) && Array.from(__v1).every(p => (typeof p === 'string'))))(value['aliases'])
  )) return false;
  return true;
}
...
export function compareUser(__a: user, __b: user): boolean {
  return (
     ...
     */
    __a['aliases'].length === __b['aliases'].length && Array.from(__a['aliases']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (__originalItem1 === __item1))(Array.from(__b['aliases'])[__index1])))
  );
}
export function updateUser(value: user, changes: Partial<userInputParams>) {
  ...
  if(typeof changes['aliases'] !== 'undefined') {
    if(!(changes['aliases'].length === value['aliases'].length && Array.from(changes['aliases']).every((__originalItem2,__index2) => (typeof __originalItem2 === 'undefined' ? false : (__item2 => typeof __item2 === 'undefined' ? false : (__originalItem2 === __item2))(Array.from(value['aliases'])[__index2]))))) {
      value = user({
        ...value,
...
export function isUserDeleted(value: unknown): value is userDeleted {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "user.userDeleted")) return false;
  if(!(
    "deletedAt" in value && ((__v0) => (typeof __v0 === 'number' && JSBI.equal(JSBI.BigInt(__v0),JSBI.BigInt(__v0)) && JSBI.greaterThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("2147483647"))))(value['deletedAt'])
  )) return false;
  return true;
}
...
export function isTest(value: unknown): value is test {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "user.test")) return false;
  if(!(
    "user" in value && ((__v0) => (isUser(__v0)))(value['user'])
  )) return false;
  if(!(
    "b" in value && ((__v1) => ((Array.isArray(__v1) || __v1 instanceof Set) && Array.from(__v1).every(p => ((Array.isArray(p) || p instanceof Set) && Array.from(p).every(p => (p === null ? true : ((x) => (typeof x === 'string'))(p)))))))(value['b'])
  )) return false;
  return true;
}
...
export function compareTest(__a: test, __b: test): boolean {
  return (
     ...
     * compare parameter b
     */
    __a['b'].length === __b['b'].length && Array.from(__a['b']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (__originalItem1.length === __item1.length && Array.from(__originalItem1).every((__originalItem2,__index2) => (typeof __originalItem2 === 'undefined' ? false : (__item2 => typeof __item2 === 'undefined' ? false : (((__dp31, __dp32) => __dp31 !== null && __dp32 !== null ? __dp31 === __dp32 : __dp31 === __dp32)(__originalItem2,__item2)))(Array.from(__item1)[__index2])))))(Array.from(__b['b'])[__index1])))
  );
}
export function updateTest(value: test, changes: Partial<testInputParams>) {
  ...
  if(typeof changes['b'] !== 'undefined') {
    if(!(changes['b'].length === value['b'].length && Array.from(changes['b']).every((__originalItem2,__index2) => (typeof __originalItem2 === 'undefined' ? false : (__item2 => typeof __item2 === 'undefined' ? false : (__originalItem2.length === __item2.length && Array.from(__originalItem2).every((__originalItem3,__index3) => (typeof __originalItem3 === 'undefined' ? false : (__item3 => typeof __item3 === 'undefined' ? false : (((__dp41, __dp42) => __dp41 !== null && __dp42 !== null ? __dp41 === __dp42 : __dp41 === __dp42)(__originalItem3,__item3)))(Array.from(__item2)[__index3])))))(Array.from(value['b'])[__index2]))))) {
      value = test({
        ...value,
        b: changes['b'],
      });
