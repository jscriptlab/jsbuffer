...
export function compareETrait(__a: E, __b: E) {
  switch(__a._name) {
    case 'test-update-function.A':
      if(__b._name !== "test-update-function.A") return false;
      return compareA(__a,__b);
    case 'test-update-function.B':
      if(__b._name !== "test-update-function.B") return false;
      return compareB(__a,__b);
    case 'test-update-function.C':
      if(__b._name !== "test-update-function.C") return false;
      return compareC(__a,__b);
    case 'test-update-function.D':
      if(__b._name !== "test-update-function.D") return false;
      return compareD(__a,__b);
  }
}
export interface A  {
  _name: 'test-update-function.A';
  a: number;
}
export function isA(value: unknown): value is A {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "test-update-function.A")) return false;
  if(!(
...
export interface B  {
  _name: 'test-update-function.B';
  a: string;
}
export function isB(value: unknown): value is B {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "test-update-function.B")) return false;
  if(!(
    "a" in value && ((__v0) => (typeof __v0 === 'string'))(value['a'])
  )) return false;
  return true;
}
...
export interface C  {
  _name: 'test-update-function.C';
  a: number;
}
export function isC(value: unknown): value is C {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "test-update-function.C")) return false;
  if(!(
    "a" in value && ((__v0) => (typeof __v0 === 'number'))(value['a'])
  )) return false;
  return true;
}
...
export interface D  {
  _name: 'test-update-function.D';
  a: number;
}
export function isD(value: unknown): value is D {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "test-update-function.D")) return false;
  if(!(
    "a" in value && ((__v0) => (typeof __v0 === 'number'))(value['a'])
  )) return false;
  return true;
...
export interface test  {
  _name: 'test-update-function.test';
  traitParam: Readonly<E>;
}
export function isTest(value: unknown): value is test {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "test-update-function.test")) return false;
  if(!(
