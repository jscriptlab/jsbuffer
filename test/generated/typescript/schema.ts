...
export function isTestMap(value: unknown): value is testMap {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.testMap")) return false;
  if(!(
    "a" in value && ((__v0) => (__v0 instanceof Map && Array.from(__v0).every(([k,v]) => (typeof k === 'string' && typeof v === 'string'))))(value['a'])
  )) return false;
  return true;
}
...
export function compareTestMap(__a: testMap, __b: testMap): boolean {
  return (
     ...
     * compare parameter a
     */
    ((l1,l2) => (l1.every(([k1,v1],i) => ((__v20 => typeof __v20 === 'undefined' ? false : k1 === __v20[0] && v1 === __v20[1])(l2[i])))))(Array.from(__a['a']),Array.from(__b['a']))
  );
}
export function updateTestMap(value: testMap, changes: Partial<testMapInputParams>) {
  if(typeof changes['a'] !== 'undefined') {
    if(!(((l1,l2) => (l1.every(([k1,v1],i) => ((__v21 => typeof __v21 === 'undefined' ? false : k1 === __v21[0] && v1 === __v21[1])(l2[i])))))(Array.from(changes['a']),Array.from(value['a'])))) {
      value = testMap({
        ...value,
        a: changes['a'],
      });
...
export function isTestBigInt(value: unknown): value is testBigInt {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.testBigInt")) return false;
  if(!(
    "beforeA" in value && ((__v0) => (typeof __v0 === 'string' && (__bigintValue0 => JSBI.greaterThanOrEqual(__bigintValue0, JSBI.BigInt("-")) && JSBI.lessThanOrEqual(__bigintValue0, JSBI.BigInt("")))(JSBI.BigInt(__v0))))(value['beforeA'])
  )) return false;
  if(!(
    "a" in value && ((__v2) => (typeof __v2 === 'string' && (__bigintValue2 => JSBI.greaterThanOrEqual(__bigintValue2, JSBI.BigInt("-")) && JSBI.lessThanOrEqual(__bigintValue2, JSBI.BigInt("")))(JSBI.BigInt(__v2))))(value['a'])
  )) return false;
  if(!(
    "b" in value && ((__v4) => (typeof __v4 === 'string' && (__bigintValue4 => JSBI.greaterThanOrEqual(__bigintValue4, JSBI.BigInt("-6703903964971298549787012499102923063739682910296196688861780721860882015036773488400937149083451713845015929093243025426876941405973284973216824503042048")) && JSBI.lessThanOrEqual(__bigintValue4, JSBI.BigInt("6703903964971298549787012499102923063739682910296196688861780721860882015036773488400937149083451713845015929093243025426876941405973284973216824503042047")))(JSBI.BigInt(__v4))))(value['b'])
  )) return false;
  if(!(
    "c" in value && ((__v6) => (typeof __v6 === 'string' && (__bigintValue6 => JSBI.greaterThanOrEqual(__bigintValue6, JSBI.BigInt("-57896044618658097711785492504343953926634992332820282019728792003956564819968")) && JSBI.lessThanOrEqual(__bigintValue6, JSBI.BigInt("57896044618658097711785492504343953926634992332820282019728792003956564819967")))(JSBI.BigInt(__v6))))(value['c'])
  )) return false;
  if(!(
    "d" in value && ((__v8) => (typeof __v8 === 'string' && (__bigintValue8 => JSBI.greaterThanOrEqual(__bigintValue8, JSBI.BigInt("-170141183460469231731687303715884105728")) && JSBI.lessThanOrEqual(__bigintValue8, JSBI.BigInt("170141183460469231731687303715884105727")))(JSBI.BigInt(__v8))))(value['d'])
  )) return false;
  if(!(
    "e" in value && ((__v10) => (typeof __v10 === 'string' && (__bigintValue10 => JSBI.greaterThanOrEqual(__bigintValue10, JSBI.BigInt("-9223372036854775808")) && JSBI.lessThanOrEqual(__bigintValue10, JSBI.BigInt("9223372036854775807")))(JSBI.BigInt(__v10))))(value['e'])
  )) return false;
  if(!(
    "f" in value && ((__v12) => (typeof __v12 === 'string' && (__bigintValue12 => JSBI.greaterThanOrEqual(__bigintValue12, JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(__bigintValue12, JSBI.BigInt("2147483647")))(JSBI.BigInt(__v12))))(value['f'])
  )) return false;
  return true;
}
...
export function defaultTestBigInt(params: Partial<testBigIntInputParams> = {}): testBigInt {
  return testBigInt({
    beforeA: "0",
    a: "0",
    b: "0",
...
export function compareTestBigInt(__a: testBigInt, __b: testBigInt): boolean {
  return (
     ...
     */
    ((a, b) => JSBI.equal(a, b))(JSBI.BigInt(__a['beforeA']),JSBI.BigInt(__b['beforeA'])) &&
    /**
     * compare parameter a
     */
    ((a, b) => JSBI.equal(a, b))(JSBI.BigInt(__a['a']),JSBI.BigInt(__b['a'])) &&
    /**
     * compare parameter b
     */
    ((a, b) => JSBI.equal(a, b))(JSBI.BigInt(__a['b']),JSBI.BigInt(__b['b'])) &&
    /**
     * compare parameter c
     */
    ((a, b) => JSBI.equal(a, b))(JSBI.BigInt(__a['c']),JSBI.BigInt(__b['c'])) &&
    /**
     * compare parameter d
     */
    ((a, b) => JSBI.equal(a, b))(JSBI.BigInt(__a['d']),JSBI.BigInt(__b['d'])) &&
    /**
     * compare parameter e
     */
    ((a, b) => JSBI.equal(a, b))(JSBI.BigInt(__a['e']),JSBI.BigInt(__b['e'])) &&
    /**
     * compare parameter f
     */
...
export function updateTestBigInt(value: testBigInt, changes: Partial<testBigIntInputParams>) {
  if(typeof changes['beforeA'] !== 'undefined') {
    if(!(((a, b) => JSBI.equal(a, b))(JSBI.BigInt(changes['beforeA']),JSBI.BigInt(value['beforeA'])))) {
      value = testBigInt({
        ...value,
  ...
  if(typeof changes['a'] !== 'undefined') {
    if(!(((a, b) => JSBI.equal(a, b))(JSBI.BigInt(changes['a']),JSBI.BigInt(value['a'])))) {
      value = testBigInt({
        ...value,
        a: changes['a'],
      });
  ...
  if(typeof changes['b'] !== 'undefined') {
    if(!(((a, b) => JSBI.equal(a, b))(JSBI.BigInt(changes['b']),JSBI.BigInt(value['b'])))) {
      value = testBigInt({
        ...value,
        b: changes['b'],
      });
  ...
  if(typeof changes['c'] !== 'undefined') {
    if(!(((a, b) => JSBI.equal(a, b))(JSBI.BigInt(changes['c']),JSBI.BigInt(value['c'])))) {
      value = testBigInt({
        ...value,
        c: changes['c'],
      });
  ...
  if(typeof changes['d'] !== 'undefined') {
    if(!(((a, b) => JSBI.equal(a, b))(JSBI.BigInt(changes['d']),JSBI.BigInt(value['d'])))) {
      value = testBigInt({
        ...value,
        d: changes['d'],
      });
  ...
  if(typeof changes['e'] !== 'undefined') {
    if(!(((a, b) => JSBI.equal(a, b))(JSBI.BigInt(changes['e']),JSBI.BigInt(value['e'])))) {
      value = testBigInt({
        ...value,
        e: changes['e'],
      });
  ...
  if(typeof changes['f'] !== 'undefined') {
    if(!(((a, b) => JSBI.equal(a, b))(JSBI.BigInt(changes['f']),JSBI.BigInt(value['f'])))) {
      value = testBigInt({
        ...value,
        f: changes['f'],
      });
...
export function isTestMap2(value: unknown): value is testMap2 {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.testMap2")) return false;
  if(!(
    "a" in value && ((__v0) => (__v0 instanceof Map && Array.from(__v0).every(([k,v]) => (k === null ? true : ((x) => (typeof x === 'string'))(k) && typeof v === 'string'))))(value['a'])
  )) return false;
  if(!(
    "b" in value && ((__v4) => (__v4 instanceof Map && Array.from(__v4).every(([k,v]) => (k === null ? true : ((x) => (typeof x === 'string'))(k) && Array.isArray(v) && (v.length === 2) && ((a) => (typeof a === 'string'))(v[0]) && ((a) => (a instanceof Map && Array.from(a).every(([k,v]) => (typeof k === 'number' && JSBI.equal(JSBI.BigInt(k),JSBI.BigInt(k)) && JSBI.greaterThanOrEqual(JSBI.BigInt(k),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(k),JSBI.BigInt("2147483647")) && typeof v === 'number' && JSBI.equal(JSBI.BigInt(v),JSBI.BigInt(v)) && JSBI.greaterThanOrEqual(JSBI.BigInt(v),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(v),JSBI.BigInt("2147483647"))))))(v[1])))))(value['b'])
  )) return false;
  return true;
}
...
export function compareTestMap2(__a: testMap2, __b: testMap2): boolean {
  return (
     ...
     * compare parameter a
     */
    ((l1,l2) => (l1.every(([k1,v1],i) => ((__v20 => typeof __v20 === 'undefined' ? false : ((__dp11, __dp12) => __dp11 !== null && __dp12 !== null ? __dp11 === __dp12 : __dp11 === __dp12)(k1,__v20[0]) && v1 === __v20[1])(l2[i])))))(Array.from(__a['a']),Array.from(__b['a'])) &&
    /**
     * compare parameter b
     */
    ((l1,l2) => (l1.every(([k1,v1],i) => ((__v21 => typeof __v21 === 'undefined' ? false : ((__dp21, __dp22) => __dp21 !== null && __dp22 !== null ? __dp21 === __dp22 : __dp21 === __dp22)(k1,__v21[0]) && /* compare tuple item 0 of type string */ ((__a40, __b40) => __a40 === __b40)(v1[0],__v21[1][0]) && /* compare tuple item 1 of type ReadonlyMap<number, number> */ ((__a41, __b41) => ((l1,l2) => (l1.every(([k1,v1],i) => ((__v27 => typeof __v27 === 'undefined' ? false : k1 === __v27[0] && v1 === __v27[1])(l2[i])))))(Array.from(__a41),Array.from(__b41)))(v1[1],__v21[1][1]))(l2[i])))))(Array.from(__a['b']),Array.from(__b['b']))
  );
}
export function updateTestMap2(value: testMap2, changes: Partial<testMap2InputParams>) {
  if(typeof changes['a'] !== 'undefined') {
    if(!(((l1,l2) => (l1.every(([k1,v1],i) => ((__v21 => typeof __v21 === 'undefined' ? false : ((__dp21, __dp22) => __dp21 !== null && __dp22 !== null ? __dp21 === __dp22 : __dp21 === __dp22)(k1,__v21[0]) && v1 === __v21[1])(l2[i])))))(Array.from(changes['a']),Array.from(value['a'])))) {
      value = testMap2({
        ...value,
        a: changes['a'],
      });
  ...
  if(typeof changes['b'] !== 'undefined') {
    if(!(((l1,l2) => (l1.every(([k1,v1],i) => ((__v25 => typeof __v25 === 'undefined' ? false : ((__dp61, __dp62) => __dp61 !== null && __dp62 !== null ? __dp61 === __dp62 : __dp61 === __dp62)(k1,__v25[0]) && /* compare tuple item 0 of type string */ ((__a80, __b80) => __a80 === __b80)(v1[0],__v25[1][0]) && /* compare tuple item 1 of type ReadonlyMap<number, number> */ ((__a81, __b81) => ((l1,l2) => (l1.every(([k1,v1],i) => ((__v211 => typeof __v211 === 'undefined' ? false : k1 === __v211[0] && v1 === __v211[1])(l2[i])))))(Array.from(__a81),Array.from(__b81)))(v1[1],__v25[1][1]))(l2[i])))))(Array.from(changes['b']),Array.from(value['b'])))) {
      value = testMap2({
        ...value,
        b: changes['b'],
      });
...
export function isTestMap3(value: unknown): value is testMap3 {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.testMap3")) return false;
  if(!(
    "a" in value && ((__v0) => (__v0 instanceof Map && Array.from(__v0).every(([k,v]) => (isTestMap2(k) && typeof v === 'string'))))(value['a'])
  )) return false;
  return true;
}
...
export function compareTestMap3(__a: testMap3, __b: testMap3): boolean {
  return (
     ...
     * compare parameter a
     */
    ((l1,l2) => (l1.every(([k1,v1],i) => ((__v20 => typeof __v20 === 'undefined' ? false : compareTestMap2(k1,__v20[0]) && v1 === __v20[1])(l2[i])))))(Array.from(__a['a']),Array.from(__b['a']))
  );
}
export function updateTestMap3(value: testMap3, changes: Partial<testMap3InputParams>) {
  if(typeof changes['a'] !== 'undefined') {
    if(!(((l1,l2) => (l1.every(([k1,v1],i) => ((__v21 => typeof __v21 === 'undefined' ? false : compareTestMap2(k1,__v21[0]) && v1 === __v21[1])(l2[i])))))(Array.from(changes['a']),Array.from(value['a'])))) {
      value = testMap3({
        ...value,
        a: changes['a'],
      });
...
export function isTestSet(value: unknown): value is testSet {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.testSet")) return false;
  if(!(
    "a" in value && ((__v0) => ((Array.isArray(__v0) || __v0 instanceof Set) && Array.from(__v0).every(p => (typeof p === 'string'))))(value['a'])
  )) return false;
  if(!(
    "b" in value && ((__v1) => ((Array.isArray(__v1) || __v1 instanceof Set) && Array.from(__v1).every(p => (typeof p === 'number' && JSBI.equal(JSBI.BigInt(p),JSBI.BigInt(p)) && JSBI.greaterThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("2147483647"))))))(value['b'])
  )) return false;
  return true;
}
...
export function compareTestSet(__a: testSet, __b: testSet): boolean {
  return (
     ...
     * compare parameter a
     */
    __a['a'].size === __b['a'].size && Array.from(__a['a']).every((__originalItem0,__index0) => (typeof __originalItem0 === 'undefined' ? false : (__item0 => typeof __item0 === 'undefined' ? false : (__originalItem0 === __item0))(Array.from(__b['a'])[__index0]))) &&
    /**
     * compare parameter b
     */
    __a['b'].size === __b['b'].size && Array.from(__a['b']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (__originalItem1 === __item1))(Array.from(__b['b'])[__index1])))
  );
}
export function updateTestSet(value: testSet, changes: Partial<testSetInputParams>) {
  if(typeof changes['a'] !== 'undefined') {
    if(!(changes['a'].size === value['a'].size && Array.from(changes['a']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (__originalItem1 === __item1))(Array.from(value['a'])[__index1]))))) {
      value = testSet({
        ...value,
        a: changes['a'],
      });
  ...
  if(typeof changes['b'] !== 'undefined') {
    if(!(changes['b'].size === value['b'].size && Array.from(changes['b']).every((__originalItem3,__index3) => (typeof __originalItem3 === 'undefined' ? false : (__item3 => typeof __item3 === 'undefined' ? false : (__originalItem3 === __item3))(Array.from(value['b'])[__index3]))))) {
      value = testSet({
        ...value,
        b: changes['b'],
      });
...
export function isTestSet2(value: unknown): value is testSet2 {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.testSet2")) return false;
  if(!(
    "a" in value && ((__v0) => ((Array.isArray(__v0) || __v0 instanceof Set) && Array.from(__v0).every(p => (typeof p === 'string'))))(value['a'])
  )) return false;
  if(!(
    "b" in value && ((__v1) => ((Array.isArray(__v1) || __v1 instanceof Set) && Array.from(__v1).every(p => (p instanceof Map && Array.from(p).every(([k,v]) => (typeof k === 'string' && typeof v === 'string'))))))(value['b'])
  )) return false;
  if(!(
    "c" in value && ((__v2) => ((Array.isArray(__v2) || __v2 instanceof Set) && Array.from(__v2).every(p => (Array.isArray(p) && (p.length === 2) && ((a) => (typeof a === 'number' && JSBI.equal(JSBI.BigInt(a),JSBI.BigInt(a)) && JSBI.greaterThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("2147483647"))))(p[0]) && ((a) => (typeof a === 'number' && JSBI.equal(JSBI.BigInt(a),JSBI.BigInt(a)) && JSBI.greaterThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("2147483647"))))(p[1])))))(value['c'])
  )) return false;
  return true;
}
...
export function compareTestSet2(__a: testSet2, __b: testSet2): boolean {
  return (
     ...
     * compare parameter b
     */
    __a['b'].size === __b['b'].size && Array.from(__a['b']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (((l1,l2) => (l1.every(([k1,v1],i) => ((__v22 => typeof __v22 === 'undefined' ? false : k1 === __v22[0] && v1 === __v22[1])(l2[i])))))(Array.from(__originalItem1),Array.from(__item1))))(Array.from(__b['b'])[__index1]))) &&
    /**
     * compare parameter c
     */
    __a['c'].size === __b['c'].size && Array.from(__a['c']).every((__originalItem2,__index2) => (typeof __originalItem2 === 'undefined' ? false : (__item2 => typeof __item2 === 'undefined' ? false : (/* compare tuple item 0 of type number */ ((__a30, __b30) => __a30 === __b30)(__originalItem2[0],__item2[0]) && /* compare tuple item 1 of type number */ ((__a31, __b31) => __a31 === __b31)(__originalItem2[1],__item2[1])))(Array.from(__b['c'])[__index2])))
  );
}
export function updateTestSet2(value: testSet2, changes: Partial<testSet2InputParams>) {
  ...
  if(typeof changes['b'] !== 'undefined') {
    if(!(changes['b'].size === value['b'].size && Array.from(changes['b']).every((__originalItem3,__index3) => (typeof __originalItem3 === 'undefined' ? false : (__item3 => typeof __item3 === 'undefined' ? false : (((l1,l2) => (l1.every(([k1,v1],i) => ((__v24 => typeof __v24 === 'undefined' ? false : k1 === __v24[0] && v1 === __v24[1])(l2[i])))))(Array.from(__originalItem3),Array.from(__item3))))(Array.from(value['b'])[__index3]))))) {
      value = testSet2({
        ...value,
        b: changes['b'],
      });
  ...
  if(typeof changes['c'] !== 'undefined') {
    if(!(changes['c'].size === value['c'].size && Array.from(changes['c']).every((__originalItem7,__index7) => (typeof __originalItem7 === 'undefined' ? false : (__item7 => typeof __item7 === 'undefined' ? false : (/* compare tuple item 0 of type number */ ((__a80, __b80) => __a80 === __b80)(__originalItem7[0],__item7[0]) && /* compare tuple item 1 of type number */ ((__a81, __b81) => __a81 === __b81)(__originalItem7[1],__item7[1])))(Array.from(value['c'])[__index7]))))) {
      value = testSet2({
        ...value,
        c: changes['c'],
      });
...
export function isVoid(value: unknown): value is Void {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.Void")) return false;
  return true;
}
...
export function isMsg(value: unknown): value is msg {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.msg")) return false;
  if(!(
...
export function isUsers(value: unknown): value is Users {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.Users")) return false;
  if(!(
    "users" in value && ((__v0) => ((Array.isArray(__v0) || __v0 instanceof Set) && Array.from(__v0).every(p => (isUserTrait(p)))))(value['users'])
  )) return false;
  return true;
}
...
export function compareUsers(__a: Users, __b: Users): boolean {
  return (
     ...
     */
    __a['users'].length === __b['users'].length && Array.from(__a['users']).every((__originalItem0,__index0) => (typeof __originalItem0 === 'undefined' ? false : (__item0 => typeof __item0 === 'undefined' ? false : (compareUserTrait(__originalItem0,__item0)))(Array.from(__b['users'])[__index0])))
  );
}
export function updateUsers(value: Users, changes: Partial<UsersInputParams>) {
  if(typeof changes['users'] !== 'undefined') {
    if(!(changes['users'].length === value['users'].length && Array.from(changes['users']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (compareUserTrait(__originalItem1,__item1)))(Array.from(value['users'])[__index1]))))) {
      value = Users({
        ...value,
        users: changes['users'],
      });
...
export function isGetUserById(value: unknown): value is GetUserById {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.GetUserById")) return false;
  if(!(
    "userId" in value && ((__v0) => (typeof __v0 === 'number' && JSBI.equal(JSBI.BigInt(__v0),JSBI.BigInt(__v0)) && JSBI.greaterThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("0")) && JSBI.lessThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("4294967295"))))(value['userId'])
  )) return false;
  return true;
}
...
export function isPost(value: unknown): value is Post {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.Post")) return false;
  if(!(
...
export function isPosts(value: unknown): value is Posts {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.Posts")) return false;
  if(!(
    "posts" in value && ((__v0) => ((Array.isArray(__v0) || __v0 instanceof Set) && Array.from(__v0).every(p => (isPost(p)))))(value['posts'])
  )) return false;
  return true;
}
...
export function comparePosts(__a: Posts, __b: Posts): boolean {
  return (
     ...
     */
    __a['posts'].length === __b['posts'].length && Array.from(__a['posts']).every((__originalItem0,__index0) => (typeof __originalItem0 === 'undefined' ? false : (__item0 => typeof __item0 === 'undefined' ? false : (comparePost(__originalItem0,__item0)))(Array.from(__b['posts'])[__index0])))
  );
}
export function updatePosts(value: Posts, changes: Partial<PostsInputParams>) {
  if(typeof changes['posts'] !== 'undefined') {
    if(!(changes['posts'].length === value['posts'].length && Array.from(changes['posts']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (comparePost(__originalItem1,__item1)))(Array.from(value['posts'])[__index1]))))) {
      value = Posts({
        ...value,
        posts: changes['posts'],
      });
...
export function isGetPostById(value: unknown): value is GetPostById {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.GetPostById")) return false;
  if(!(
    "postId" in value && ((__v0) => (typeof __v0 === 'number' && JSBI.equal(JSBI.BigInt(__v0),JSBI.BigInt(__v0)) && JSBI.greaterThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("0")) && JSBI.lessThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("4294967295"))))(value['postId'])
  )) return false;
  return true;
}
...
export function isGetConversations(value: unknown): value is GetConversations {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.GetConversations")) return false;
  return true;
}
...
export function isCoordinates(value: unknown): value is Coordinates {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.Coordinates")) return false;
  if(!(
    "latitude" in value && ((__v0) => (typeof __v0 === 'number'))(value['latitude'])
  )) return false;
  if(!(
    "longitude" in value && ((__v1) => (typeof __v1 === 'number'))(value['longitude'])
  )) return false;
  return true;
}
...
export function isShouldSupportSeveralSequentialVectorParams(value: unknown): value is ShouldSupportSeveralSequentialVectorParams {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.ShouldSupportSeveralSequentialVectorParams")) return false;
  if(!(
    "a" in value && ((__v0) => ((Array.isArray(__v0) || __v0 instanceof Set) && Array.from(__v0).every(p => (typeof p === 'number' && JSBI.equal(JSBI.BigInt(p),JSBI.BigInt(p)) && JSBI.greaterThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("2147483647"))))))(value['a'])
  )) return false;
  if(!(
    "b" in value && ((__v1) => ((Array.isArray(__v1) || __v1 instanceof Set) && Array.from(__v1).every(p => (typeof p === 'number'))))(value['b'])
  )) return false;
  if(!(
    "c" in value && ((__v2) => ((Array.isArray(__v2) || __v2 instanceof Set) && Array.from(__v2).every(p => (typeof p === 'string'))))(value['c'])
  )) return false;
  if(!(
    "d" in value && ((__v3) => ((Array.isArray(__v3) || __v3 instanceof Set) && Array.from(__v3).every(p => (typeof p === 'number'))))(value['d'])
  )) return false;
  if(!(
    "e" in value && ((__v4) => ((Array.isArray(__v4) || __v4 instanceof Set) && Array.from(__v4).every(p => (typeof p === 'number' && JSBI.equal(JSBI.BigInt(p),JSBI.BigInt(p)) && JSBI.greaterThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("0")) && JSBI.lessThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("4294967295"))))))(value['e'])
  )) return false;
  if(!(
    "f" in value && ((__v5) => ((Array.isArray(__v5) || __v5 instanceof Set) && Array.from(__v5).every(p => (p === null ? true : ((x) => ((Array.isArray(x) || x instanceof Set) && Array.from(x).every(p => (typeof p === 'number' && JSBI.equal(JSBI.BigInt(p),JSBI.BigInt(p)) && JSBI.greaterThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("0")) && JSBI.lessThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("4294967295"))))))(p)))))(value['f'])
  )) return false;
  if(!(
    "g" in value && ((__v6) => (Array.isArray(__v6) && (__v6.length === 5) && ((a) => (typeof a === 'number' && JSBI.equal(JSBI.BigInt(a),JSBI.BigInt(a)) && JSBI.greaterThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("2147483647"))))(__v6[0]) && ((a) => (typeof a === 'number'))(__v6[1]) && ((a) => (typeof a === 'number'))(__v6[2]) && ((a) => ((Array.isArray(a) || a instanceof Set) && Array.from(a).every(p => (typeof p === 'number' && JSBI.equal(JSBI.BigInt(p),JSBI.BigInt(p)) && JSBI.greaterThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("0")) && JSBI.lessThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("4294967295"))))))(__v6[3]) && ((a) => (a === null ? true : ((x) => (typeof x === 'string'))(a)))(__v6[4])))(value['g'])
  )) return false;
  return true;
}
...
export function compareShouldSupportSeveralSequentialVectorParams(__a: ShouldSupportSeveralSequentialVectorParams, __b: ShouldSupportSeveralSequentialVectorParams): boolean {
  return (
     ...
     * compare parameter a
     */
    __a['a'].length === __b['a'].length && Array.from(__a['a']).every((__originalItem0,__index0) => (typeof __originalItem0 === 'undefined' ? false : (__item0 => typeof __item0 === 'undefined' ? false : (__originalItem0 === __item0))(Array.from(__b['a'])[__index0]))) &&
    /**
     * compare parameter b
     */
    __a['b'].length === __b['b'].length && Array.from(__a['b']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (__originalItem1 === __item1))(Array.from(__b['b'])[__index1]))) &&
    /**
     * compare parameter c
     */
    __a['c'].length === __b['c'].length && Array.from(__a['c']).every((__originalItem2,__index2) => (typeof __originalItem2 === 'undefined' ? false : (__item2 => typeof __item2 === 'undefined' ? false : (__originalItem2 === __item2))(Array.from(__b['c'])[__index2]))) &&
    /**
     * compare parameter d
     */
    __a['d'].length === __b['d'].length && Array.from(__a['d']).every((__originalItem3,__index3) => (typeof __originalItem3 === 'undefined' ? false : (__item3 => typeof __item3 === 'undefined' ? false : (__originalItem3 === __item3))(Array.from(__b['d'])[__index3]))) &&
    /**
     * compare parameter e
     */
    __a['e'].length === __b['e'].length && Array.from(__a['e']).every((__originalItem4,__index4) => (typeof __originalItem4 === 'undefined' ? false : (__item4 => typeof __item4 === 'undefined' ? false : (__originalItem4 === __item4))(Array.from(__b['e'])[__index4]))) &&
    /**
     * compare parameter f
     */
    __a['f'].length === __b['f'].length && Array.from(__a['f']).every((__originalItem5,__index5) => (typeof __originalItem5 === 'undefined' ? false : (__item5 => typeof __item5 === 'undefined' ? false : (((__dp61, __dp62) => __dp61 !== null && __dp62 !== null ? __dp61.length === __dp62.length && Array.from(__dp61).every((__originalItem7,__index7) => (typeof __originalItem7 === 'undefined' ? false : (__item7 => typeof __item7 === 'undefined' ? false : (__originalItem7 === __item7))(Array.from(__dp62)[__index7]))) : __dp61 === __dp62)(__originalItem5,__item5)))(Array.from(__b['f'])[__index5]))) &&
    /**
     * compare parameter g
     */
    /* compare tuple item 0 of type number */ ((__a60, __b60) => __a60 === __b60)(__a['g'][0],__b['g'][0]) && /* compare tuple item 1 of type number */ ((__a61, __b61) => __a61 === __b61)(__a['g'][1],__b['g'][1]) && /* compare tuple item 2 of type number */ ((__a62, __b62) => __a62 === __b62)(__a['g'][2],__b['g'][2]) && /* compare tuple item 3 of type ReadonlyArray<number> */ ((__a63, __b63) => __a63.length === __b63.length && Array.from(__a63).every((__originalItem16,__index16) => (typeof __originalItem16 === 'undefined' ? false : (__item16 => typeof __item16 === 'undefined' ? false : (__originalItem16 === __item16))(Array.from(__b63)[__index16]))))(__a['g'][3],__b['g'][3]) && /* compare tuple item 4 of type string | null */ ((__a64, __b64) => ((__dp221, __dp222) => __dp221 !== null && __dp222 !== null ? __dp221 === __dp222 : __dp221 === __dp222)(__a64,__b64))(__a['g'][4],__b['g'][4])
  );
}
export function updateShouldSupportSeveralSequentialVectorParams(value: ShouldSupportSeveralSequentialVectorParams, changes: Partial<ShouldSupportSeveralSequentialVectorParamsInputParams>) {
  if(typeof changes['a'] !== 'undefined') {
    if(!(changes['a'].length === value['a'].length && Array.from(changes['a']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (__originalItem1 === __item1))(Array.from(value['a'])[__index1]))))) {
  ...
  if(typeof changes['b'] !== 'undefined') {
    if(!(changes['b'].length === value['b'].length && Array.from(changes['b']).every((__originalItem3,__index3) => (typeof __originalItem3 === 'undefined' ? false : (__item3 => typeof __item3 === 'undefined' ? false : (__originalItem3 === __item3))(Array.from(value['b'])[__index3]))))) {
      value = ShouldSupportSeveralSequentialVectorParams({
        ...value,
        b: changes['b'],
      });
  ...
  if(typeof changes['c'] !== 'undefined') {
    if(!(changes['c'].length === value['c'].length && Array.from(changes['c']).every((__originalItem5,__index5) => (typeof __originalItem5 === 'undefined' ? false : (__item5 => typeof __item5 === 'undefined' ? false : (__originalItem5 === __item5))(Array.from(value['c'])[__index5]))))) {
      value = ShouldSupportSeveralSequentialVectorParams({
        ...value,
        c: changes['c'],
      });
  ...
  if(typeof changes['d'] !== 'undefined') {
    if(!(changes['d'].length === value['d'].length && Array.from(changes['d']).every((__originalItem7,__index7) => (typeof __originalItem7 === 'undefined' ? false : (__item7 => typeof __item7 === 'undefined' ? false : (__originalItem7 === __item7))(Array.from(value['d'])[__index7]))))) {
      value = ShouldSupportSeveralSequentialVectorParams({
        ...value,
        d: changes['d'],
      });
  ...
  if(typeof changes['e'] !== 'undefined') {
    if(!(changes['e'].length === value['e'].length && Array.from(changes['e']).every((__originalItem9,__index9) => (typeof __originalItem9 === 'undefined' ? false : (__item9 => typeof __item9 === 'undefined' ? false : (__originalItem9 === __item9))(Array.from(value['e'])[__index9]))))) {
      value = ShouldSupportSeveralSequentialVectorParams({
        ...value,
        e: changes['e'],
      });
  ...
  if(typeof changes['f'] !== 'undefined') {
    if(!(changes['f'].length === value['f'].length && Array.from(changes['f']).every((__originalItem11,__index11) => (typeof __originalItem11 === 'undefined' ? false : (__item11 => typeof __item11 === 'undefined' ? false : (((__dp121, __dp122) => __dp121 !== null && __dp122 !== null ? __dp121.length === __dp122.length && Array.from(__dp121).every((__originalItem13,__index13) => (typeof __originalItem13 === 'undefined' ? false : (__item13 => typeof __item13 === 'undefined' ? false : (__originalItem13 === __item13))(Array.from(__dp122)[__index13]))) : __dp121 === __dp122)(__originalItem11,__item11)))(Array.from(value['f'])[__index11]))))) {
      value = ShouldSupportSeveralSequentialVectorParams({
        ...value,
        f: changes['f'],
      });
  ...
  if(typeof changes['g'] !== 'undefined') {
    if(!(/* compare tuple item 0 of type number */ ((__a150, __b150) => __a150 === __b150)(changes['g'][0],value['g'][0]) && /* compare tuple item 1 of type number */ ((__a151, __b151) => __a151 === __b151)(changes['g'][1],value['g'][1]) && /* compare tuple item 2 of type number */ ((__a152, __b152) => __a152 === __b152)(changes['g'][2],value['g'][2]) && /* compare tuple item 3 of type ReadonlyArray<number> */ ((__a153, __b153) => __a153.length === __b153.length && Array.from(__a153).every((__originalItem25,__index25) => (typeof __originalItem25 === 'undefined' ? false : (__item25 => typeof __item25 === 'undefined' ? false : (__originalItem25 === __item25))(Array.from(__b153)[__index25]))))(changes['g'][3],value['g'][3]) && /* compare tuple item 4 of type string | null */ ((__a154, __b154) => ((__dp311, __dp312) => __dp311 !== null && __dp312 !== null ? __dp311 === __dp312 : __dp311 === __dp312)(__a154,__b154))(changes['g'][4],value['g'][4]))) {
      value = ShouldSupportSeveralSequentialVectorParams({
        ...value,
        g: changes['g'],
      });
...
export function isSimpleTupleTest(value: unknown): value is simpleTupleTest {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.simpleTupleTest")) return false;
  if(!(
    "a" in value && ((__v0) => (Array.isArray(__v0) && (__v0.length === 5) && ((a) => (typeof a === 'number' && JSBI.equal(JSBI.BigInt(a),JSBI.BigInt(a)) && JSBI.greaterThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("2147483647"))))(__v0[0]) && ((a) => (typeof a === 'number'))(__v0[1]) && ((a) => (typeof a === 'number'))(__v0[2]) && ((a) => ((Array.isArray(a) || a instanceof Set) && Array.from(a).every(p => (typeof p === 'number' && JSBI.equal(JSBI.BigInt(p),JSBI.BigInt(p)) && JSBI.greaterThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("0")) && JSBI.lessThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("4294967295"))))))(__v0[3]) && ((a) => (a === null ? true : ((x) => (typeof x === 'string'))(a)))(__v0[4])))(value['a'])
  )) return false;
  if(!(
    "b" in value && ((__v7) => ((Array.isArray(__v7) || __v7 instanceof Set) && Array.from(__v7).every(p => (Array.isArray(p) && (p.length === 5) && ((a) => (typeof a === 'number' && JSBI.equal(JSBI.BigInt(a),JSBI.BigInt(a)) && JSBI.greaterThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(a),JSBI.BigInt("2147483647"))))(p[0]) && ((a) => (typeof a === 'number'))(p[1]) && ((a) => (typeof a === 'number'))(p[2]) && ((a) => ((Array.isArray(a) || a instanceof Set) && Array.from(a).every(p => (typeof p === 'number' && JSBI.equal(JSBI.BigInt(p),JSBI.BigInt(p)) && JSBI.greaterThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("0")) && JSBI.lessThanOrEqual(JSBI.BigInt(p),JSBI.BigInt("4294967295"))))))(p[3]) && ((a) => (a === null ? true : ((x) => (typeof x === 'string'))(a)))(p[4])))))(value['b'])
  )) return false;
  return true;
}
...
export function compareSimpleTupleTest(__a: simpleTupleTest, __b: simpleTupleTest): boolean {
  return (
     ...
     * compare parameter a
     */
    /* compare tuple item 0 of type number */ ((__a00, __b00) => __a00 === __b00)(__a['a'][0],__b['a'][0]) && /* compare tuple item 1 of type number */ ((__a01, __b01) => __a01 === __b01)(__a['a'][1],__b['a'][1]) && /* compare tuple item 2 of type number */ ((__a02, __b02) => __a02 === __b02)(__a['a'][2],__b['a'][2]) && /* compare tuple item 3 of type ReadonlyArray<number> */ ((__a03, __b03) => __a03.length === __b03.length && Array.from(__a03).every((__originalItem10,__index10) => (typeof __originalItem10 === 'undefined' ? false : (__item10 => typeof __item10 === 'undefined' ? false : (__originalItem10 === __item10))(Array.from(__b03)[__index10]))))(__a['a'][3],__b['a'][3]) && /* compare tuple item 4 of type string | null */ ((__a04, __b04) => ((__dp161, __dp162) => __dp161 !== null && __dp162 !== null ? __dp161 === __dp162 : __dp161 === __dp162)(__a04,__b04))(__a['a'][4],__b['a'][4]) &&
    /**
     * compare parameter b
     */
    __a['b'].length === __b['b'].length && Array.from(__a['b']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (/* compare tuple item 0 of type number */ ((__a20, __b20) => __a20 === __b20)(__originalItem1[0],__item1[0]) && /* compare tuple item 1 of type number */ ((__a21, __b21) => __a21 === __b21)(__originalItem1[1],__item1[1]) && /* compare tuple item 2 of type number */ ((__a22, __b22) => __a22 === __b22)(__originalItem1[2],__item1[2]) && /* compare tuple item 3 of type ReadonlyArray<number> */ ((__a23, __b23) => __a23.length === __b23.length && Array.from(__a23).every((__originalItem12,__index12) => (typeof __originalItem12 === 'undefined' ? false : (__item12 => typeof __item12 === 'undefined' ? false : (__originalItem12 === __item12))(Array.from(__b23)[__index12]))))(__originalItem1[3],__item1[3]) && /* compare tuple item 4 of type string | null */ ((__a24, __b24) => ((__dp181, __dp182) => __dp181 !== null && __dp182 !== null ? __dp181 === __dp182 : __dp181 === __dp182)(__a24,__b24))(__originalItem1[4],__item1[4])))(Array.from(__b['b'])[__index1])))
  );
}
export function updateSimpleTupleTest(value: simpleTupleTest, changes: Partial<simpleTupleTestInputParams>) {
  if(typeof changes['a'] !== 'undefined') {
    if(!(/* compare tuple item 0 of type number */ ((__a10, __b10) => __a10 === __b10)(changes['a'][0],value['a'][0]) && /* compare tuple item 1 of type number */ ((__a11, __b11) => __a11 === __b11)(changes['a'][1],value['a'][1]) && /* compare tuple item 2 of type number */ ((__a12, __b12) => __a12 === __b12)(changes['a'][2],value['a'][2]) && /* compare tuple item 3 of type ReadonlyArray<number> */ ((__a13, __b13) => __a13.length === __b13.length && Array.from(__a13).every((__originalItem11,__index11) => (typeof __originalItem11 === 'undefined' ? false : (__item11 => typeof __item11 === 'undefined' ? false : (__originalItem11 === __item11))(Array.from(__b13)[__index11]))))(changes['a'][3],value['a'][3]) && /* compare tuple item 4 of type string | null */ ((__a14, __b14) => ((__dp171, __dp172) => __dp171 !== null && __dp172 !== null ? __dp171 === __dp172 : __dp171 === __dp172)(__a14,__b14))(changes['a'][4],value['a'][4]))) {
  ...
  if(typeof changes['b'] !== 'undefined') {
    if(!(changes['b'].length === value['b'].length && Array.from(changes['b']).every((__originalItem19,__index19) => (typeof __originalItem19 === 'undefined' ? false : (__item19 => typeof __item19 === 'undefined' ? false : (/* compare tuple item 0 of type number */ ((__a200, __b200) => __a200 === __b200)(__originalItem19[0],__item19[0]) && /* compare tuple item 1 of type number */ ((__a201, __b201) => __a201 === __b201)(__originalItem19[1],__item19[1]) && /* compare tuple item 2 of type number */ ((__a202, __b202) => __a202 === __b202)(__originalItem19[2],__item19[2]) && /* compare tuple item 3 of type ReadonlyArray<number> */ ((__a203, __b203) => __a203.length === __b203.length && Array.from(__a203).every((__originalItem30,__index30) => (typeof __originalItem30 === 'undefined' ? false : (__item30 => typeof __item30 === 'undefined' ? false : (__originalItem30 === __item30))(Array.from(__b203)[__index30]))))(__originalItem19[3],__item19[3]) && /* compare tuple item 4 of type string | null */ ((__a204, __b204) => ((__dp361, __dp362) => __dp361 !== null && __dp362 !== null ? __dp361 === __dp362 : __dp361 === __dp362)(__a204,__b204))(__originalItem19[4],__item19[4])))(Array.from(value['b'])[__index19]))))) {
      value = simpleTupleTest({
        ...value,
        b: changes['b'],
      });
...
export function isEmptyNode(value: unknown): value is emptyNode {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.emptyNode")) return false;
  return true;
}
...
export function isUser(value: unknown): value is user {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.user")) return false;
  if(!(
    "id" in value && ((__v0) => (typeof __v0 === 'number' && JSBI.equal(JSBI.BigInt(__v0),JSBI.BigInt(__v0)) && JSBI.greaterThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("-2147483648")) && JSBI.lessThanOrEqual(JSBI.BigInt(__v0),JSBI.BigInt("2147483647"))))(value['id'])
  )) return false;
  if(!(
...
export function isSupportNullTerminatedString(value: unknown): value is supportNullTerminatedString {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.supportNullTerminatedString")) return false;
  if(!(
...
export function isNullTerminatedStringList(value: unknown): value is nullTerminatedStringList {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.nullTerminatedStringList")) return false;
  if(!(
    "value" in value && ((__v0) => ((Array.isArray(__v0) || __v0 instanceof Set) && Array.from(__v0).every(p => (typeof p === 'string'))))(value['value'])
  )) return false;
  return true;
}
...
export function compareNullTerminatedStringList(__a: nullTerminatedStringList, __b: nullTerminatedStringList): boolean {
  return (
     ...
     * compare parameter value
     */
    __a['value'].length === __b['value'].length && Array.from(__a['value']).every((__originalItem0,__index0) => (typeof __originalItem0 === 'undefined' ? false : (__item0 => typeof __item0 === 'undefined' ? false : (__originalItem0 === __item0))(Array.from(__b['value'])[__index0])))
  );
}
export function updateNullTerminatedStringList(value: nullTerminatedStringList, changes: Partial<nullTerminatedStringListInputParams>) {
  if(typeof changes['value'] !== 'undefined') {
    if(!(changes['value'].length === value['value'].length && Array.from(changes['value']).every((__originalItem1,__index1) => (typeof __originalItem1 === 'undefined' ? false : (__item1 => typeof __item1 === 'undefined' ? false : (__originalItem1 === __item1))(Array.from(value['value'])[__index1]))))) {
...
export function isNormalStringList(value: unknown): value is normalStringList {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.normalStringList")) return false;
  if(!(
    "value" in value && ((__v0) => ((Array.isArray(__v0) || __v0 instanceof Set) && Array.from(__v0).every(p => (typeof p === 'string'))))(value['value'])
  )) return false;
  return true;
...
export function isBoolAndTuple(value: unknown): value is boolAndTuple {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "schema.boolAndTuple")) return false;
  if(!(
    "sorryIJustLoveTuples" in value && ((__v0) => (Array.isArray(__v0) && (__v0.length === 3) && ((a) => (typeof a === 'boolean'))(__v0[0]) && ((a) => (typeof a === 'boolean'))(__v0[1]) && ((a) => (Array.isArray(a) && (a.length === 2) && ((a) => (typeof a === 'boolean'))(a[0]) && ((a) => (typeof a === 'boolean'))(a[1])))(__v0[2])))(value['sorryIJustLoveTuples'])
  )) return false;
  return true;
}
