...
export function isA0(value: unknown): value is A0 {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "test-trait-on-param.A0")) return false;
  if(!(
    "value" in value && ((__v0) => (isATrait(__v0)))(value['value'])
  )) return false;
  return true;
}
...
export function isA1(value: unknown): value is A1 {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "test-trait-on-param.A1")) return false;
  if(!(
    "value" in value && ((__v0) => (isATrait(__v0)))(value['value'])
  )) return false;
  return true;
...
export function isA2(value: unknown): value is A2 {
  if(!(typeof value === 'object' && value !== null && '_name' in value && typeof value['_name'] === 'string' && value['_name'] === "test-trait-on-param.A2")) return false;
  if(!(
    "value" in value && ((__v0) => (isATrait(__v0)))(value['value'])
  )) return false;
  return true;
