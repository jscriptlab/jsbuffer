...
export function isJSBExtensionTest(value: unknown): value is JSBExtensionTest {
  if (
    !(
      ...
      value['_name'] === 'jsb-extension.JSBExtensionTest'
    )
  )
    return false;
  if (
...
export function JSBExtensionTest(
  params: JSBExtensionTestInputParams
): JSBExtensionTest {
  return {
    _name: 'jsb-extension.JSBExtensionTest',
    a: params['a']
...
export function encodeJSBExtensionTest(
  __s: ISerializer,
...
export function decodeJSBExtensionTest(
  __d: IDeserializer
): JSBExtensionTest | null {
...
export function defaultJSBExtensionTest(
  params: Partial<JSBExtensionTestInputParams> = {}
): JSBExtensionTest {
...
export function compareJSBExtensionTest(
  __a: JSBExtensionTest,
  __b: JSBExtensionTest
): boolean {
  return (
    /**
     * compare parameter a
...
export function updateJSBExtensionTest(
  value: JSBExtensionTest,
  changes: Partial<JSBExtensionTestInputParams>
) {
