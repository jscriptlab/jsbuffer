...
enum jsb_result_t protocol_main_response_trait_encode(
  ...
  case PROTOCOL_MAIN_VOID_TYPE:
    JSB_TRACE("protocol_main_response_trait_encode/protocol.main.Response",
              "Encoding protocol.main.Void...");
    JSB_CHECK_ERROR(
        protocol_main_void_encode(&input->value.protocol_main_void, s));
    break;
  case PROTOCOL_MAIN_USER_TYPE:
    JSB_TRACE("protocol_main_response_trait_encode/protocol.main.Response",
              "Encoding protocol.main.User...");
    JSB_CHECK_ERROR(
        protocol_main_user_encode(&input->value.protocol_main_user, s));
    break;
  default:
    JSB_TRACE("protocol_main_response_trait_encode/protocol.main.Response",
              "Invalid type: %d. Maybe you've forgot to initialize `struct "
              "protocol_main_response_trait_t`?\n",
              input->type);
...
enum jsb_result_t protocol_main_response_trait_decode(
    ...
    struct protocol_main_response_trait_t* output) {
  if (d == NULL) {
    JSB_TRACE("protocol_main_response_trait_decode",
              "Failed to decode protocol.main.Response, received NULL pointer "
  ...
  switch (header) {
  case 357013552:
    JSB_TRACE("protocol_main_response_trait_decode/protocol.main.Response",
              "Decoding protocol.main.Void...");
    JSB_CHECK_ERROR(
        protocol_main_void_decode(d, &output->value.protocol_main_void));
    break;
  case 1081421617:
    JSB_TRACE("protocol_main_response_trait_decode/protocol.main.Response",
              "Decoding protocol.main.User...");
    JSB_CHECK_ERROR(
        protocol_main_user_decode(d, &output->value.protocol_main_user));
    break;
  default:
    JSB_TRACE("protocol.main.Response/decode",
...
protocol_main_response_trait_init(struct protocol_main_response_trait_t* input,
  ...
  if (input == NULL) {
    JSB_TRACE("protocol_main_response_trait_init",
              "Failed to initialize protocol.main.Response, received NULL "
...
void protocol_main_response_trait_free(
    struct protocol_main_response_trait_t* trait) {
  if (trait == NULL) {
    JSB_TRACE(
        "protocol_main_response_trait_free",
        "Failed to free 'protocol.main.Response', received NULL pointer.");
    return;
  }
  JSB_TRACE("protocol_main_response_trait_free",
            "Freeing trait: protocol.main.Response.");
  switch (trait->type) {
  case PROTOCOL_MAIN_VOID_TYPE:
    JSB_TRACE("protocol_main_response_trait_free",
              "Identified protocol.main.Response trait to have its value as: "
              "protocol.main.Void.");
  ...
  case PROTOCOL_MAIN_USER_TYPE:
    ...
    break;
  default:
    JSB_TRACE("protocol.main.Response/free",
