...
void protocol_main_request_trait_free(struct protocol_main_request_trait_t* input);
enum jsb_result_t protocol_main_request_trait_init(struct protocol_main_request_trait_t* input,enum protocol_main_request_type_t);
enum jsb_result_t protocol_main_request_trait_decode(struct jsb_deserializer_t* d, struct protocol_main_request_trait_t* result);
#ifdef __cplusplus
}
#endif // __cplusplus
