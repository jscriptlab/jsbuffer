...
enum jsb_result_t app_message_decode(struct jsb_deserializer_t* d, struct app_message_t* result) {
  {
    ...
    if(header != 1001184143) {
      JSB_TRACE("app_message_decode", "Invalid CRC header for app.Message. Expected 1001184143, but got %d instead.", header);
  ...
  {
    JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->command1.has_value));
    if(result->command1.has_value != 1 && result->command1.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->command1. The returned value for optional was not zero or one: %d\n", result->command1.has_value);
  ...
  {
    JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->command2.has_value));
    if(result->command2.has_value != 1 && result->command2.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->command2. The returned value for optional was not zero or one: %d\n", result->command2.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->command2.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->command2.value.has_value));
        if(result->command2.value.has_value != 1 && result->command2.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->command2.value. The returned value for optional was not zero or one: %d\n", result->command2.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->command2.value.has_value) {
          JSB_CHECK_ERROR(app_command_trait_decode(d, &result->command2.value.value));
        }
      }
    }
  }
  ...
  {
    JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->command3.has_value));
    if(result->command3.has_value != 1 && result->command3.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->command3. The returned value for optional was not zero or one: %d\n", result->command3.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->command3.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->command3.value.has_value));
        if(result->command3.value.has_value != 1 && result->command3.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->command3.value. The returned value for optional was not zero or one: %d\n", result->command3.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->command3.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->command3.value.value.has_value));
            if(result->command3.value.value.has_value != 1 && result->command3.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->command3.value.value. The returned value for optional was not zero or one: %d\n", result->command3.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->command3.value.value.has_value) {
              JSB_CHECK_ERROR(app_command_trait_decode(d, &result->command3.value.value.value));
            }
          }
        }
      }
  ...
  {
    JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->command4.has_value));
    if(result->command4.has_value != 1 && result->command4.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->command4. The returned value for optional was not zero or one: %d\n", result->command4.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->command4.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->command4.value.has_value));
        if(result->command4.value.has_value != 1 && result->command4.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->command4.value. The returned value for optional was not zero or one: %d\n", result->command4.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->command4.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->command4.value.value.has_value));
            if(result->command4.value.value.has_value != 1 && result->command4.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->command4.value.value. The returned value for optional was not zero or one: %d\n", result->command4.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->command4.value.value.has_value) {
              {
                JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->command4.value.value.value.has_value));
                if(result->command4.value.value.value.has_value != 1 && result->command4.value.value.value.has_value != 0) {
                  JSB_TRACE("decode", "Failed to decode result->command4.value.value.value. The returned value for optional was not zero or one: %d\n", result->command4.value.value.value.has_value);
                  return JSB_INVALID_DECODED_VALUE;
                }
                if(result->command4.value.value.value.has_value) {
                  JSB_CHECK_ERROR(app_command_trait_decode(d, &result->command4.value.value.value.value));
                }
              }
            }
          }
  ...
  JSB_TRACE("app_message_decode", "Decoding value1...");
  {
    ...
    if(result->value1.has_value != 1 && result->value1.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value1. The returned value for optional was not zero or one: %d\n", result->value1.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->value1.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value1.value.has_value));
        if(result->value1.value.has_value != 1 && result->value1.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->value1.value. The returned value for optional was not zero or one: %d\n", result->value1.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->value1.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value1.value.value.has_value));
            if(result->value1.value.value.has_value != 1 && result->value1.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->value1.value.value. The returned value for optional was not zero or one: %d\n", result->value1.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->value1.value.value.has_value) {
              {
                JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value1.value.value.value.has_value));
                if(result->value1.value.value.value.has_value != 1 && result->value1.value.value.value.has_value != 0) {
                  JSB_TRACE("decode", "Failed to decode result->value1.value.value.value. The returned value for optional was not zero or one: %d\n", result->value1.value.value.value.has_value);
                  return JSB_INVALID_DECODED_VALUE;
                }
                if(result->value1.value.value.value.has_value) {
                  JSB_CHECK_ERROR(jsb_deserializer_read_int32(d, &result->value1.value.value.value.value));
                }
              }
            }
          }
  ...
  JSB_TRACE("app_message_decode", "Decoding value2...");
  {
    ...
    if(result->value2.has_value != 1 && result->value2.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value2. The returned value for optional was not zero or one: %d\n", result->value2.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->value2.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value2.value.has_value));
        if(result->value2.value.has_value != 1 && result->value2.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->value2.value. The returned value for optional was not zero or one: %d\n", result->value2.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->value2.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value2.value.value.has_value));
            if(result->value2.value.value.has_value != 1 && result->value2.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->value2.value.value. The returned value for optional was not zero or one: %d\n", result->value2.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->value2.value.value.has_value) {
              {
                JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value2.value.value.value.has_value));
                if(result->value2.value.value.value.has_value != 1 && result->value2.value.value.value.has_value != 0) {
                  JSB_TRACE("decode", "Failed to decode result->value2.value.value.value. The returned value for optional was not zero or one: %d\n", result->value2.value.value.value.has_value);
                  return JSB_INVALID_DECODED_VALUE;
                }
                if(result->value2.value.value.value.has_value) {
                  JSB_CHECK_ERROR(jsb_deserializer_read_int16(d, &result->value2.value.value.value.value));
                }
              }
            }
          }
  ...
  JSB_TRACE("app_message_decode", "Decoding value3...");
  {
    ...
    if(result->value3.has_value != 1 && result->value3.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value3. The returned value for optional was not zero or one: %d\n", result->value3.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->value3.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value3.value.has_value));
        if(result->value3.value.has_value != 1 && result->value3.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->value3.value. The returned value for optional was not zero or one: %d\n", result->value3.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->value3.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value3.value.value.has_value));
            if(result->value3.value.value.has_value != 1 && result->value3.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->value3.value.value. The returned value for optional was not zero or one: %d\n", result->value3.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->value3.value.value.has_value) {
              {
                JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value3.value.value.value.has_value));
                if(result->value3.value.value.value.has_value != 1 && result->value3.value.value.value.has_value != 0) {
                  JSB_TRACE("decode", "Failed to decode result->value3.value.value.value. The returned value for optional was not zero or one: %d\n", result->value3.value.value.value.has_value);
                  return JSB_INVALID_DECODED_VALUE;
                }
                if(result->value3.value.value.value.has_value) {
                  JSB_CHECK_ERROR(jsb_deserializer_read_int8(d, &result->value3.value.value.value.value));
                }
              }
            }
          }
  ...
  JSB_TRACE("app_message_decode", "Decoding value4...");
  {
    ...
    if(result->value4.has_value != 1 && result->value4.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value4. The returned value for optional was not zero or one: %d\n", result->value4.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->value4.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value4.value.has_value));
        if(result->value4.value.has_value != 1 && result->value4.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->value4.value. The returned value for optional was not zero or one: %d\n", result->value4.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->value4.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value4.value.value.has_value));
            if(result->value4.value.value.has_value != 1 && result->value4.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->value4.value.value. The returned value for optional was not zero or one: %d\n", result->value4.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->value4.value.value.has_value) {
              {
                JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value4.value.value.value.has_value));
                if(result->value4.value.value.value.has_value != 1 && result->value4.value.value.value.has_value != 0) {
                  JSB_TRACE("decode", "Failed to decode result->value4.value.value.value. The returned value for optional was not zero or one: %d\n", result->value4.value.value.value.has_value);
                  return JSB_INVALID_DECODED_VALUE;
                }
                if(result->value4.value.value.value.has_value) {
                  JSB_CHECK_ERROR(jsb_deserializer_read_int32(d, &result->value4.value.value.value.value));
                }
              }
            }
          }
  ...
  JSB_TRACE("app_message_decode", "Decoding value5...");
  {
    ...
    if(result->value5.has_value != 1 && result->value5.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value5. The returned value for optional was not zero or one: %d\n", result->value5.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->value5.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value5.value.has_value));
        if(result->value5.value.has_value != 1 && result->value5.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->value5.value. The returned value for optional was not zero or one: %d\n", result->value5.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->value5.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value5.value.value.has_value));
            if(result->value5.value.value.has_value != 1 && result->value5.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->value5.value.value. The returned value for optional was not zero or one: %d\n", result->value5.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->value5.value.value.has_value) {
              {
                JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value5.value.value.value.has_value));
                if(result->value5.value.value.value.has_value != 1 && result->value5.value.value.value.has_value != 0) {
                  JSB_TRACE("decode", "Failed to decode result->value5.value.value.value. The returned value for optional was not zero or one: %d\n", result->value5.value.value.value.has_value);
                  return JSB_INVALID_DECODED_VALUE;
                }
                if(result->value5.value.value.value.has_value) {
                  JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value5.value.value.value.value));
                }
              }
            }
          }
  ...
  JSB_TRACE("app_message_decode", "Decoding value6...");
  {
    ...
    if(result->value6.has_value != 1 && result->value6.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value6. The returned value for optional was not zero or one: %d\n", result->value6.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->value6.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value6.value.has_value));
        if(result->value6.value.has_value != 1 && result->value6.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->value6.value. The returned value for optional was not zero or one: %d\n", result->value6.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->value6.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value6.value.value.has_value));
            if(result->value6.value.value.has_value != 1 && result->value6.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->value6.value.value. The returned value for optional was not zero or one: %d\n", result->value6.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->value6.value.value.has_value) {
              {
                JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value6.value.value.value.has_value));
                if(result->value6.value.value.value.has_value != 1 && result->value6.value.value.value.has_value != 0) {
                  JSB_TRACE("decode", "Failed to decode result->value6.value.value.value. The returned value for optional was not zero or one: %d\n", result->value6.value.value.value.has_value);
                  return JSB_INVALID_DECODED_VALUE;
                }
                if(result->value6.value.value.value.has_value) {
                  JSB_CHECK_ERROR(jsb_deserializer_read_uint16(d, &result->value6.value.value.value.value));
                }
              }
            }
          }
  ...
  JSB_TRACE("app_message_decode", "Decoding value7...");
  {
    ...
    if(result->value7.has_value != 1 && result->value7.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value7. The returned value for optional was not zero or one: %d\n", result->value7.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->value7.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value7.value.has_value));
        if(result->value7.value.has_value != 1 && result->value7.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->value7.value. The returned value for optional was not zero or one: %d\n", result->value7.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->value7.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value7.value.value.has_value));
            if(result->value7.value.value.has_value != 1 && result->value7.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->value7.value.value. The returned value for optional was not zero or one: %d\n", result->value7.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->value7.value.value.has_value) {
              {
                JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value7.value.value.value.has_value));
                if(result->value7.value.value.value.has_value != 1 && result->value7.value.value.value.has_value != 0) {
                  JSB_TRACE("decode", "Failed to decode result->value7.value.value.value. The returned value for optional was not zero or one: %d\n", result->value7.value.value.value.has_value);
                  return JSB_INVALID_DECODED_VALUE;
                }
                if(result->value7.value.value.value.has_value) {
                  JSB_CHECK_ERROR(jsb_deserializer_read_uint32(d, &result->value7.value.value.value.value));
                }
              }
            }
          }
  ...
  JSB_TRACE("app_message_decode", "Decoding value8...");
  {
    ...
    if(result->value8.has_value != 1 && result->value8.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value8. The returned value for optional was not zero or one: %d\n", result->value8.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->value8.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value8.value.has_value));
        if(result->value8.value.has_value != 1 && result->value8.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->value8.value. The returned value for optional was not zero or one: %d\n", result->value8.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->value8.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value8.value.value.has_value));
            if(result->value8.value.value.has_value != 1 && result->value8.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->value8.value.value. The returned value for optional was not zero or one: %d\n", result->value8.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->value8.value.value.has_value) {
              {
                JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value8.value.value.value.has_value));
                if(result->value8.value.value.value.has_value != 1 && result->value8.value.value.value.has_value != 0) {
                  JSB_TRACE("decode", "Failed to decode result->value8.value.value.value. The returned value for optional was not zero or one: %d\n", result->value8.value.value.value.has_value);
                  return JSB_INVALID_DECODED_VALUE;
                }
...
#endif
                    JSB_CHECK_ERROR(jsb_deserializer_read_buffer(d, len, result->value8.value.value.value.value));
  ...
  JSB_TRACE("app_message_decode", "Decoding value9...");
  {
    ...
    if(result->value9.has_value != 1 && result->value9.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value9. The returned value for optional was not zero or one: %d\n", result->value9.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
  ...
  JSB_TRACE("app_message_decode", "Decoding value10...");
  {
    ...
    if(result->value10.has_value != 1 && result->value10.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value10. The returned value for optional was not zero or one: %d\n", result->value10.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
  ...
  JSB_TRACE("app_message_decode", "Decoding value11...");
  {
    ...
    if(result->value11.has_value != 1 && result->value11.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value11. The returned value for optional was not zero or one: %d\n", result->value11.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
  ...
  JSB_TRACE("app_message_decode", "Decoding value12...");
  {
    ...
    if(result->value12.has_value != 1 && result->value12.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value12. The returned value for optional was not zero or one: %d\n", result->value12.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
  ...
  JSB_TRACE("app_message_decode", "Decoding value13...");
  {
    ...
    if(result->value13.has_value != 1 && result->value13.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value13. The returned value for optional was not zero or one: %d\n", result->value13.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
  ...
  JSB_TRACE("app_message_decode", "Decoding value14...");
  {
    ...
    if(result->value14.has_value != 1 && result->value14.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value14. The returned value for optional was not zero or one: %d\n", result->value14.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
  ...
  JSB_TRACE("app_message_decode", "Decoding value15...");
  {
    ...
    if(result->value15.has_value != 1 && result->value15.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value15. The returned value for optional was not zero or one: %d\n", result->value15.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
  ...
  JSB_TRACE("app_message_decode", "Decoding value16...");
  {
    ...
    if(result->value16.has_value != 1 && result->value16.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value16. The returned value for optional was not zero or one: %d\n", result->value16.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->value16.has_value) {
      {
        ...
        if(len > JSB_MAX_STRING_SIZE) return JSB_BUFFER_OVERFLOW;
#endif
        JSB_CHECK_ERROR(jsb_deserializer_read_buffer(d, len, result->value16.value));
  ...
  JSB_TRACE("app_message_decode", "Decoding value17...");
  {
    ...
    if(result->value17.has_value != 1 && result->value17.has_value != 0) {
      JSB_TRACE("decode", "Failed to decode result->value17. The returned value for optional was not zero or one: %d\n", result->value17.has_value);
      return JSB_INVALID_DECODED_VALUE;
    }
    if(result->value17.has_value) {
      {
        JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value17.value.has_value));
        if(result->value17.value.has_value != 1 && result->value17.value.has_value != 0) {
          JSB_TRACE("decode", "Failed to decode result->value17.value. The returned value for optional was not zero or one: %d\n", result->value17.value.has_value);
          return JSB_INVALID_DECODED_VALUE;
        }
        if(result->value17.value.has_value) {
          {
            JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value17.value.value.has_value));
            if(result->value17.value.value.has_value != 1 && result->value17.value.value.has_value != 0) {
              JSB_TRACE("decode", "Failed to decode result->value17.value.value. The returned value for optional was not zero or one: %d\n", result->value17.value.value.has_value);
              return JSB_INVALID_DECODED_VALUE;
            }
            if(result->value17.value.value.has_value) {
              {
                JSB_CHECK_ERROR(jsb_deserializer_read_uint8(d, &result->value17.value.value.value.has_value));
                if(result->value17.value.value.value.has_value != 1 && result->value17.value.value.value.has_value != 0) {
                  JSB_TRACE("decode", "Failed to decode result->value17.value.value.value. The returned value for optional was not zero or one: %d\n", result->value17.value.value.value.has_value);
                  return JSB_INVALID_DECODED_VALUE;
                }
                if(result->value17.value.value.value.has_value) {
                  JSB_CHECK_ERROR(app_deep_optional_decode(d, &result->value17.value.value.value.value));
                }
              }
            }
          }
...
enum jsb_result_t app_message_encode(const struct app_message_t* input, struct jsb_serializer_t* s) {
  ...
  if(input->command2.has_value) {
    ...
    if(input->command2.value.has_value) {
      ...
      JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
      JSB_TRACE("", "Encoding app.Command...");
      JSB_CHECK_ERROR(app_command_trait_encode(&input->command2.value.value, s));
    } else {
  ...
  if(input->command3.has_value) {
    ...
    if(input->command3.value.has_value) {
      ...
      if(input->command3.value.value.has_value) {
        ...
        JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
        JSB_TRACE("", "Encoding app.Command...");
        JSB_CHECK_ERROR(app_command_trait_encode(&input->command3.value.value.value, s));
      } else {
        JSB_TRACE("", "Optional value of input->command3.value.value is empty.");
        JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
      }
    } else {
    ...
    if(input->command4.value.has_value) {
      ...
      if(input->command4.value.value.has_value) {
        ...
        if(input->command4.value.value.value.has_value) {
          JSB_TRACE("", "Optional value of input->command4.value.value.value is set.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
          JSB_TRACE("", "Encoding app.Command...");
          JSB_CHECK_ERROR(app_command_trait_encode(&input->command4.value.value.value.value, s));
        } else {
          JSB_TRACE("", "Optional value of input->command4.value.value.value is empty.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
        }
      } else {
        JSB_TRACE("", "Optional value of input->command4.value.value is empty.");
        JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
      }
    } else {
    ...
    if(input->value1.value.has_value) {
      ...
      if(input->value1.value.value.has_value) {
        ...
        if(input->value1.value.value.value.has_value) {
          JSB_TRACE("", "Optional value of input->value1.value.value.value is set.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
          JSB_CHECK_ERROR(jsb_serializer_write_int32(s, input->value1.value.value.value.value));
        } else {
          JSB_TRACE("", "Optional value of input->value1.value.value.value is empty.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
        }
      } else {
    ...
    if(input->value2.value.has_value) {
      ...
      if(input->value2.value.value.has_value) {
        ...
        if(input->value2.value.value.value.has_value) {
          JSB_TRACE("", "Optional value of input->value2.value.value.value is set.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
          JSB_CHECK_ERROR(jsb_serializer_write_int16(s, input->value2.value.value.value.value));
        } else {
          JSB_TRACE("", "Optional value of input->value2.value.value.value is empty.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
        }
      } else {
    ...
    if(input->value3.value.has_value) {
      ...
      if(input->value3.value.value.has_value) {
        ...
        if(input->value3.value.value.value.has_value) {
          JSB_TRACE("", "Optional value of input->value3.value.value.value is set.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
          JSB_CHECK_ERROR(jsb_serializer_write_int8(s, input->value3.value.value.value.value));
        } else {
          JSB_TRACE("", "Optional value of input->value3.value.value.value is empty.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
        }
      } else {
    ...
    if(input->value4.value.has_value) {
      ...
      if(input->value4.value.value.has_value) {
        ...
        if(input->value4.value.value.value.has_value) {
          JSB_TRACE("", "Optional value of input->value4.value.value.value is set.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
          JSB_CHECK_ERROR(jsb_serializer_write_int32(s, input->value4.value.value.value.value));
        } else {
          JSB_TRACE("", "Optional value of input->value4.value.value.value is empty.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
        }
      } else {
    ...
    if(input->value5.value.has_value) {
      ...
      if(input->value5.value.value.has_value) {
        ...
        if(input->value5.value.value.value.has_value) {
          JSB_TRACE("", "Optional value of input->value5.value.value.value is set.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, input->value5.value.value.value.value));
        } else {
          JSB_TRACE("", "Optional value of input->value5.value.value.value is empty.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
        }
      } else {
    ...
    if(input->value6.value.has_value) {
      ...
      if(input->value6.value.value.has_value) {
        ...
        if(input->value6.value.value.value.has_value) {
          JSB_TRACE("", "Optional value of input->value6.value.value.value is set.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
          JSB_CHECK_ERROR(jsb_serializer_write_uint16(s, input->value6.value.value.value.value));
        } else {
          JSB_TRACE("", "Optional value of input->value6.value.value.value is empty.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
        }
      } else {
    ...
    if(input->value7.value.has_value) {
      ...
      if(input->value7.value.value.has_value) {
        ...
        if(input->value7.value.value.value.has_value) {
          JSB_TRACE("", "Optional value of input->value7.value.value.value is set.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
          JSB_CHECK_ERROR(jsb_serializer_write_uint32(s, input->value7.value.value.value.value));
        } else {
          JSB_TRACE("", "Optional value of input->value7.value.value.value is empty.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
        }
      } else {
    ...
    if(input->value8.value.has_value) {
      ...
      if(input->value8.value.value.has_value) {
        ...
        if(input->value8.value.value.value.has_value) {
          JSB_TRACE("", "Optional value of input->value8.value.value.value is set.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
          {
            // Length of the buffer
            const jsb_uint32_t len = jsb_strlen(input->value8.value.value.value.value);
            JSB_CHECK_ERROR(jsb_serializer_write_uint32(s, len));
            JSB_CHECK_ERROR(jsb_serializer_write_buffer(s, input->value8.value.value.value.value, len));
          }
        } else {
          JSB_TRACE("", "Optional value of input->value8.value.value.value is empty.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
        }
      } else {
  ...
  if(input->value16.has_value) {
    ...
    JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
    {
      ...
      JSB_CHECK_ERROR(jsb_serializer_write_uint32(s, len));
      JSB_CHECK_ERROR(jsb_serializer_write_buffer(s, input->value16.value, len));
    }
  } else {
    ...
    if(input->value17.value.has_value) {
      ...
      if(input->value17.value.value.has_value) {
        ...
        if(input->value17.value.value.value.has_value) {
          JSB_TRACE("", "Optional value of input->value17.value.value.value is set.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 1));
          JSB_TRACE("", "Encoding app.DeepOptional...");
          JSB_CHECK_ERROR(app_deep_optional_encode(&input->value17.value.value.value.value, s));
        } else {
          JSB_TRACE("", "Optional value of input->value17.value.value.value is empty.");
          JSB_CHECK_ERROR(jsb_serializer_write_uint8(s, 0));
        }
      } else {
...
enum jsb_result_t app_message_init(struct app_message_t* value) {
  if(value == NULL) {
    JSB_TRACE("app_message_init", "Failed to initialize app.Message, received value = NULL.");
    return JSB_BAD_ARGUMENT;
  }
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_command_trait_t\": command.");
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_command_optional_t\": command1.");
  /**
   * struct app_message_command_optional_t
   */
  value->command1.has_value = false;
  JSB_CHECK_ERROR(app_command_trait_init(&value->command1.value, APP_COMMAND_MOVE_FORWARD_TYPE));
  JSB_TRACE("app_message_init", "Initialized param: command1.");

  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_command_optional_optional_t\": command2.");
  /**
  ...
  JSB_CHECK_ERROR(app_command_trait_init(&value->command2.value.value, APP_COMMAND_MOVE_FORWARD_TYPE));
  JSB_TRACE("app_message_init", "Initialized param: command2.");

  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_command_optional_optional_optional_t\": command3.");
  /**
  ...
  JSB_CHECK_ERROR(app_command_trait_init(&value->command3.value.value.value, APP_COMMAND_MOVE_FORWARD_TYPE));
  JSB_TRACE("app_message_init", "Initialized param: command3.");

  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_command_optional_optional_optional_optional_t\": command4.");
  /**
  ...
  JSB_CHECK_ERROR(app_command_trait_init(&value->command4.value.value.value.value, APP_COMMAND_MOVE_FORWARD_TYPE));
  JSB_TRACE("app_message_init", "Initialized param: command4.");

  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_int_optional_optional_optional_optional_t\": value1.");
  /**
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_int16_optional_optional_optional_optional_t\": value2.");
  /**
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_int8_optional_optional_optional_optional_t\": value3.");
  /**
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_int32_optional_optional_optional_optional_t\": value4.");
  /**
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_uint8_optional_optional_optional_optional_t\": value5.");
  /**
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_uint16_optional_optional_optional_optional_t\": value6.");
  /**
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_uint32_optional_optional_optional_optional_t\": value7.");
  /**
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_string_optional_optional_optional_optional_t\": value8.");
  /**
   ...
   *
   * 1. Have additional value->value8.value.value.value.value_len and value->value8.value.value.value.value_capacity members
...
#error "JSB_SCHEMA_MALLOC is not implemented yet"
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_int_optional_t\": value9.");
  /**
   * struct app_message_int_optional_t
   */
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_int16_optional_t\": value10.");
  /**
   * struct app_message_int16_optional_t
   */
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_int8_optional_t\": value11.");
  /**
   * struct app_message_int8_optional_t
   */
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_int32_optional_t\": value12.");
  /**
   * struct app_message_int32_optional_t
   */
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_uint8_optional_t\": value13.");
  /**
   * struct app_message_uint8_optional_t
   */
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_uint16_optional_t\": value14.");
  /**
   * struct app_message_uint16_optional_t
   */
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_uint32_optional_t\": value15.");
  /**
   * struct app_message_uint32_optional_t
   */
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_string_optional_t\": value16.");
  /**
   * struct app_message_string_optional_t
   */
   ...
   * Here we should have something similar the following options:
   *
   * 1. Have additional value->value16.value_len and value->value16.value_capacity members
   * in order to control the maximum capacity of the memory block and be able to fully set it to zero.
   *
   * 2. We could simply stick to the null-terminated string in order to keep it simple.
   *
...
#error "JSB_SCHEMA_MALLOC is not implemented yet"
  ...
  JSB_TRACE("app_message_init", "Initializing param of type \"struct app_message_deepoptional_optional_optional_optional_optional_t\": value17.");
  /**
  ...
  JSB_CHECK_ERROR(app_deep_optional_init(&value->value17.value.value.value.value));
...
enum jsb_result_t app_message_command1_init(struct app_message_t* message, const struct app_command_trait_t* command1){
...
enum jsb_result_t app_message_command2_init(struct app_message_t* message, const struct app_command_trait_t* command2){
...
enum jsb_result_t app_message_command3_init(struct app_message_t* message, const struct app_command_trait_t* command3){
...
enum jsb_result_t app_message_command4_init(struct app_message_t* message, const struct app_command_trait_t* command4){
...
enum jsb_result_t app_message_value1_init(struct app_message_t* message, const jsb_int32_t* value1){
...
enum jsb_result_t app_message_value2_init(struct app_message_t* message, const jsb_int16_t* value2){
...
enum jsb_result_t app_message_value3_init(struct app_message_t* message, const jsb_int8_t* value3){
...
enum jsb_result_t app_message_value4_init(struct app_message_t* message, const jsb_int32_t* value4){
...
enum jsb_result_t app_message_value5_init(struct app_message_t* message, const jsb_uint8_t* value5){
...
enum jsb_result_t app_message_value6_init(struct app_message_t* message, const jsb_uint16_t* value6){
...
enum jsb_result_t app_message_value7_init(struct app_message_t* message, const jsb_uint32_t* value7){
...
enum jsb_result_t app_message_value8_init(struct app_message_t* message, const jsb_string_t* value8){
    ...
    if(message->value8.value.has_value) {
      ...
      if(message->value8.value.value.has_value) {
        ...
        if(message->value8.value.value.value.has_value) {
          jsb_memcpy(&message->value8.value.value.value.value, &value8, jsb_strlen(*value8));
        }
      }
    }
  }
...
enum jsb_result_t app_message_value9_init(struct app_message_t* message, const jsb_int32_t* value9){
...
enum jsb_result_t app_message_value10_init(struct app_message_t* message, const jsb_int16_t* value10){
...
enum jsb_result_t app_message_value11_init(struct app_message_t* message, const jsb_int8_t* value11){
...
enum jsb_result_t app_message_value12_init(struct app_message_t* message, const jsb_int32_t* value12){
...
enum jsb_result_t app_message_value13_init(struct app_message_t* message, const jsb_uint8_t* value13){
...
enum jsb_result_t app_message_value14_init(struct app_message_t* message, const jsb_uint16_t* value14){
...
enum jsb_result_t app_message_value15_init(struct app_message_t* message, const jsb_uint32_t* value15){
...
enum jsb_result_t app_message_value16_init(struct app_message_t* message, const jsb_string_t* value16){
...
enum jsb_result_t app_message_value17_init(struct app_message_t* message, const struct app_deep_optional_t* value17){
