...
enum jsb_result_t app_command_move_backwards_decode(struct jsb_deserializer_t* d, struct app_command_move_backwards_t* result) {
  {
    JSB_TRACE("app_command_move_backwards_decode", "Decoding app.CommandMoveBackwards...");
    jsb_int32_t header;
    JSB_CHECK_ERROR(jsb_deserializer_read_int32(d, &header));
    if(header != 985001043) {
      JSB_TRACE("app_command_move_backwards_decode", "Invalid CRC header for app.CommandMoveBackwards. Expected 985001043, but got %d instead.", header);
...
enum jsb_result_t app_command_move_backwards_encode(const struct app_command_move_backwards_t* input, struct jsb_serializer_t* s) {
  JSB_TRACE("app_command_move_backwards_encode", "Encoding app.CommandMoveBackwards...");
...
enum jsb_result_t app_command_move_backwards_init(struct app_command_move_backwards_t* value) {
  if(value == NULL) {
    JSB_TRACE("app_command_move_backwards_init", "Failed to initialize app.CommandMoveBackwards, received value = NULL.");
    return JSB_BAD_ARGUMENT;
  }
  JSB_TRACE("app_command_move_backwards_init", "Initializing param of type \"bool\": stop.");
  /**
   * bool
   */
  value->stop = false;
  ...
  JSB_TRACE("app_command_move_backwards_init", "Initializing param of type \"jsb_bytes_t\": value.");
  /**
   * jsb_bytes_t
   */
...
#error "JSB_SCHEMA_MALLOC is not implemented yet"
  ...
  JSB_TRACE("app_command_move_backwards_init", "Initializing param of type \"jsb_float_t\": value2.");
  /**
   * jsb_float_t
   */
  value->value2 = 0.0f;
