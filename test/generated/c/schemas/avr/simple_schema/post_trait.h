...
enum jsb_result_t simple_schema_post_trait_init(struct simple_schema_post_trait_t* input,enum simple_schema_post_type_t);
enum jsb_result_t simple_schema_post_trait_decode(struct jsb_deserializer_t* d, struct simple_schema_post_trait_t* result);
#ifdef __cplusplus
}
#endif // __cplusplus
