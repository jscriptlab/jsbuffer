...
enum jsb_result_t simple_schema_user_decode(struct jsb_deserializer_t*, struct simple_schema_user_t*);
enum jsb_result_t simple_schema_user_encode(const struct simple_schema_user_t*, struct jsb_serializer_t*);
...
/**
 *@brief Initialize the optional value on last_post parameter of struct simple_schema_user_t
 *@param[in] user The struct to set the property on
 *@param[in] last_post The optional value to initialize. Pass NULL to unset the optional value
