...
enum jsb_result_t
simple_schema_post_deleted_decode(struct jsb_deserializer_t*,
                                  struct simple_schema_post_deleted_t*);
enum jsb_result_t
simple_schema_post_deleted_encode(const struct simple_schema_post_deleted_t*,
                                  struct jsb_serializer_t*);
enum jsb_result_t
simple_schema_post_deleted_init(struct simple_schema_post_deleted_t*);
