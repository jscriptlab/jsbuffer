...
enum jsb_result_t protocol_main_get_user_decode(struct jsb_deserializer_t*, struct protocol_main_get_user_t*);
enum jsb_result_t protocol_main_get_user_encode(const struct protocol_main_get_user_t*, struct jsb_serializer_t*);
