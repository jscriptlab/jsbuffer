...
schema_internal_test::internal::ImportMeWithId
schema_internal_test::internal::ImportMeWithId::decode(jsb::deserializer& d) {
  {
...
void schema_internal_test::internal::ImportMeWithId::encode(
    jsb::serializer& s) const {
