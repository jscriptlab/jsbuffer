...
export function compareTupleTest(__a: tupleTest, __b: tupleTest) {
  return (
     ...
     */
    /* compare tuple item 0 of type user */ ((__a00, __b00) =>
      compareUser(__a00, __b00))(__a['data'][0], __b['data'][0]) &&
    /* compare tuple item 1 of type post */ ((__a01, __b01) =>
      comparePost(__a01, __b01))(__a['data'][1], __b['data'][1]) &&
    /* compare tuple item 2 of type comment */ ((__a02, __b02) =>
      compareComment(__a02, __b02))(__a['data'][2], __b['data'][2]) &&
    /* compare tuple item 3 of type ReadonlyArray<comment> */ ((__a03, __b03) =>
      __a03.length === __b03.length &&
      __a03.every((__i, index) => compareComment(__i, __b03[index])))(
      __a['data'][3],
      __b['data'][3]
    ) &&
    /* compare tuple item 4 of type ReadonlyArray<comment | null> */ ((
      __a04,
      __b04
    ) =>
      ...
      __a04.every((__i, index) =>
        ((__dp61, __dp62) =>
          __dp61 !== null && __dp62 !== null
            ? compareComment(__dp61, __dp62)
            : __dp61 === __dp62)(__i, __b04[index])
    ...
    if (
      !(
        /* compare tuple item 0 of type user */ (
          ((__a00, __b00) => compareUser(__a00, __b00))(
            changes['data'][0],
            value['data'][0]
          ) &&
          /* compare tuple item 1 of type post */ ((__a01, __b01) =>
            comparePost(__a01, __b01))(changes['data'][1], value['data'][1]) &&
          /* compare tuple item 2 of type comment */ ((__a02, __b02) =>
            compareComment(__a02, __b02))(
            changes['data'][2],
            value['data'][2]
          ) &&
          /* compare tuple item 3 of type ReadonlyArray<comment> */ ((
            __a03,
            __b03
          ) =>
            __a03.length === __b03.length &&
